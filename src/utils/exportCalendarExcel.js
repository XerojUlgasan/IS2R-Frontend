...
export function exportCalendarExcel(detail, meta = {}) {
  ...
  const headers = ["Material", "Unit", "Stock Added", "Consumed", "Sales Count", "Sales Amount (₱)", "Deleted Sales", "Deleted Stocks"];
  ...
  ws["!merges"] = [
    ...
    { s: { r: 1, c: 0 }, e: { r: 1, c: 7 } }, // Subtitle row
    { s: { r: 2, c: 0 }, e: { r: 2, c: 7 } }, // Date row
    { s: { r: 3, c: 0 }, e: { r: 3, c: 7 } }, // Period row
  ];
