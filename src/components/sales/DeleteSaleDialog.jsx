      ...
      >
        <div className="flex items-start gap-md">
          ...
          <div className="flex flex-col gap-xs">
            <h2 className="font-headline-lg text-headline-md text-on-surface uppercase tracking-tight">Delete Sale</h2>
            <p className="font-body-sm text-body-sm text-on-surface-variant">
              Delete the sale for <span className="font-bold text-on-surface">{label}</span>? This action cannot be undone.
            </p>
          </div>
        </div>
